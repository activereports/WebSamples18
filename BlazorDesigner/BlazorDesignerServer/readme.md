# Blazor Designer Server sample

Sample demonstrates how to make Blazor Server Application with GrapeCity ActiveReports Blazor Designer using local report service and remote report service.
